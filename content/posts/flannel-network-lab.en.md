...
## III. web01 Host Configuration (Host1: 192.168.8.188)
...
[root@web01 ~]# docker exec -it <container_id> /bin/bash
```
...
![web01 Container Network Verification](/images/flannel/page6_img1.png)

## IV. web02 Host Configuration (Host2: 192.168.0.208)

### Step Description

1. Configuration steps are identical to web01, only need to modify the following parameters:
...
Ping web02 container IP (example: 172.16.9.2) from web01 container:
